...
JUMO.Util =  {
    ...
    isinstanceof : PROTOCROCK.isinstanceof,
    ...
    handelError: function(response, jObj){
    ...
    followUnfollow: function(ent_id, ent_type, user_id, jObj, thumb_location) {
        ...
        this.postJSON('user/action/follow/', {
                          ...
                          if (data.result !== undefined) {
                              JUMO.Modules.Tracking.trackAction(actionType, {
                                                                   "Followed ID":   ent_id,
    ...
    showYoutubeVideo: function(appendToId, divID, youtubeID, width, height) {
        ...
        var w = String(width) || "450"; 
        var h = String(height) || "321"; 
